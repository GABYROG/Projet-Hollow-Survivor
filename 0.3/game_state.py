...
Contient :
  ...
  - Les donnees de la partie en cours (joueur, ennemis, fleches, paniers,exp)
  - L'etat de l'ecran courant (menu / weapon_select / playing / game_over)
"""

import pygame

from settings import WEAPON_ORDER, GOLD_GAIN_BASE,EXP_GAIN_BASE
...
class GameState:
    ...
    def __init__(self, map_data: MapData):
        ...
        if self.exp >=self.nextlevel:
            self.nextlevel+=self.nextlevel+1/2*self.nextlevel
            self.exp=0
